...
class CircleMarkerPublisher(Node):
    def __init__(self):
        ...
        "Just a standard helping node for better visualisation of where the ee actually is"
    ...
    def publish_marker(self):
        ...
        for i in range(steps + 1):
            ...
            left_marker.points.append(Point(x=x, y=y, z=0.0))
        ...
        for i in range(steps + 1):
            ...
            x = radius * math.cos(angle)
            y = radius * math.sin(angle)
            right_marker.points.append(Point(x=x, y=y, z=0.0))
